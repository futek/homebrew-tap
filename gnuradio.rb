class Gnuradio < Formula
  ...
  resource "cython" do
    url "https://github.com/cython/cython/archive/0.23.4.tar.gz"
    sha256 "f0fdc2d39a313dedd80b2ef45b63c925f6633579df37967092f6f32fb0dd6023"
  end

  resource "numpy" do
    url "https://github.com/numpy/numpy/archive/v1.10.1.tar.gz"
    sha256 "53a9045ad97f649c07d90a3df80e2cbf236ee9792f4fa629e9a6a512c73b984e"
  end
  ...
  def install
    ...
    res = %w[Markdown Cheetah lxml cython numpy]
